        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body pb-4">
              <label htmlFor="categoryName1" className="form-label">
                Top Level Category
              </label>
              <select id='categoryName1' value={topCategoryId} onChange={(e) => setTopCategoryId(e.target.value)} className="form-select" aria-label="Default select example">
              ...
              <label htmlFor="categoryNameSec" className="form-label pt-3">
