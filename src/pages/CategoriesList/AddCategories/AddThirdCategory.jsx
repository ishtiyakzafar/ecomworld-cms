        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body pb-4">
              <label htmlFor="categoryName2" className="form-label">
                Top Level Category
              </label>
              <select
                id='categoryName2'
              ...
              <label htmlFor="categoryNameSec2" className="form-label pt-3">
              ...
              <label htmlFor="categoryNameThird" className="form-label pt-3">
